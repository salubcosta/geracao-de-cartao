...
Este projeto trata-se da geração de cartão de visita de clientes de forma

## Orientação:

1. Configurar o arquivo .htaccess para acessar o diretório de instalaçaõ correto.

2. Configurar o arquivo environment.php para definir a constante URL.

## Informações:

1. Projeto criado no Padrão MV
